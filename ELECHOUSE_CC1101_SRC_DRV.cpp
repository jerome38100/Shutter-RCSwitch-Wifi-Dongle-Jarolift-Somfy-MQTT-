...
uint8_t PA_TABLEJARO[8]     {0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
 /****************************************************************/
...
{
  // disable SPI
//Add JDE  SPI.endTransaction();
   SPI.end();
//Add JDE  digitalWrite(SCK_PIN, LOW);
}
/****************************************************************
...
{
//Add JDE  	digitalWrite(SS_PIN, LOW);
//Add JDE  	delay(1);
//Add JDE  	digitalWrite(SS_PIN, HIGH);
//Add JDE  	delay(1);
...
//add JDE  digitalWrite(SS_PIN, HIGH);
//Add JDE  digitalWrite(SCK_PIN, HIGH);
//Add JDE  digitalWrite(MOSI_PIN, LOW);
  Reset();                    //CC1101 reset
...
{   
    ...
    SpiWriteReg(CC1101_MDMCFG4,  0x69);
    SpiWriteReg(CC1101_MDMCFG3,  0xE4);
    ...
    SpiWriteReg(CC1101_AGCCTRL2, 0x04); //
...
// Carrier frequency = 433.42 MHz
#define CC1101_DEFVAL_FREQ2_43342  0x10        // Frequency Control Word, High Byte
#define CC1101_DEFVAL_FREQ1_43342  0xAB         // Frequency Control Word, Middle Byte
#define CC1101_DEFVAL_FREQ0_43342  0x85        // Frequency Control Word, Low Byte
...
{
//Add JDE a  SpiStrobe(CC1101_SIDLE);
...
{
  setMHZ(mhz);
//Add JDE  SpiStrobe(CC1101_SIDLE);
  SpiStrobe(CC1101_STX);        //start send
  trxstate=1;
}
/****************************************************************
