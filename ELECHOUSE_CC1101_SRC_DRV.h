...
#define CC1101_CFG_SIZE 0x2F //47  
 
  const uint8_t CC1101_JAROLIFT_RTS_CFG[CC1101_CFG_SIZE] = {
  // Jarolif IDX NAME COMMENT
  ...
  0xB0,// 0E FREQ1 
  0x71,// 0F FREQ0 
  0x69,// 10 MDMCFG4 bWidth 325kHz
  0xE4,// 11 MDMCFG3 Drate: 828 ((256+11)*2^5)*26000000/2^28
  0x30,// 12 MDMCFG2 Modulation: ASK
  0x22,// 13 MDMCFG1 
  0xF8,// 14 MDMCFG0 ChannelSpace: 350kHz
  0x00,// 15 DEVIATN 
  0x07,// 16 MCSM2 
  0x30,// 17 MCSM1 
  ...
  0x14,// 19 FOCCFG 
  0x6C,// 1A BSCFG 
  0x04,// 1B AGCCTRL2 42 dB instead of 33dB
  0x00,// 1C AGCCTRL1 
  0x92,// 1D AGCCTRL0 4dB decision boundery
  0x87,// 1E WOREVT1 
  0x6B,// 1F WOREVT0 
  0xF8,// 20 WORCTRL 
  0xB6,// 21 FREND1 
