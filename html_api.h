...
void html_api() {
  ...
  if (server.args() > 0 ) {
    ...
    for ( uint8_t i = 0; i < server.args(); i++ ) {
      ...
      if (server.argName(i) == "set_somfycounter")
        config.set_somfycounter = (urldecode(server.arg(i)) == "true");
      if (server.argName(i) == "somfycounter")
        config.new_somfycounter = urldecode(server.arg(i));
      if (server.argName(i) == "set_jaroliftcounter")
        config.set_jaroliftcounter = (urldecode(server.arg(i)) == "true");
      if (server.argName(i) == "jaroliftcounter")
        config.new_jaroliftcounter = urldecode(server.arg(i));
    } // for
    if (cmd != "") {
      if (cmd == "eventlog") {
        String values = "";
        ...
        server.send ( 200, "text/plain", values );
       } else if (cmd == "get somfy name") {
        String values = "";
        values += "somfy_16=" + config.channel_name[16] + "\n";
        values += "somfy_17=" + config.channel_name[17] + "\n";
        values += "somfy_18=" + config.channel_name[18] + "\n";
        values += "somfy_19=" + config.channel_name[19] + "\n";
        values += "somfy_20=" + config.channel_name[20] + "\n";
        values += "somfy_21=" + config.channel_name[21] + "\n";
        values += "somfy_22=" + config.channel_name[22] + "\n";
        values += "somfy_23=" + config.channel_name[23] + "\n";
        values += "somfy_24=" + config.channel_name[24] + "\n";
        values += "somfy_25=" + config.channel_name[25] + "\n";
        values += "somfy_26=" + config.channel_name[26] + "\n";
        values += "somfy_27=" + config.channel_name[27] + "\n";
        values += "somfy_28=" + config.channel_name[28] + "\n";
        values += "somfy_29=" + config.channel_name[29] + "\n";
        values += "somfy_30=" + config.channel_name[20] + "\n";
        values += "somfy_31=" + config.channel_name[31] + "\n";
        server.send ( 200, "text/plain", values );
        ...
        values += "jaroliftcounter=" + (String)jaroliftcnt + "\n";
        values += "checkbox=set_jaroliftcounter=0\n";
        values += "somfycounter=" + (String)somfycnt + "\n";
        values += "checkbox=set_somfycounter=0\n";
